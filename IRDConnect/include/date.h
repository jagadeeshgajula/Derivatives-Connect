    ...
    */
    ...
    class Date {
      public:
    	...
    	Date( const char * date, std::string pic );
    	Date( const Date & date );

    	std::string string();
    	std::string string(std::string dateFormat);
        ...
        Day day() { return dayOfMonth(); } //alias for dayOfMonth()
        //! One-based (Jan 1st = 1)
        Day dayOfYear() const;
        Month month() const;
        Year year() const;
        ...
        static Date getValuationDate() { return Date(_valuationDate); };
        static void setValuationDate(Date date) { _valuationDate = date.serialNumber_; };
       // static void setValuationDate(Day d, int m, Year y); //{ _valuationDate = Date(d,m,y); };
      ...
      private:
        ...
        static BigInteger  _valuationDate;
